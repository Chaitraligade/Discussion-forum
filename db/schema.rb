...
ActiveRecord::Schema[7.1].define(version: 2025_03_31_101210) do
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "thread_chat_id"
    t.bigint "user_id"
    t.integer "reply_to_id"
    t.index ["thread_chat_id"], name: "index_messages_on_thread_chat_id"
  ...
  create_table "thread_chats", force: :cascade do |t|
    t.string "title"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id"
    t.index ["user_id"], name: "index_thread_chats_on_user_id"
  end
  ...
  add_foreign_key "messages", "thread_chats"
  add_foreign_key "messages", "users"
  add_foreign_key "notifications", "users"
  add_foreign_key "taggings", "tags"
  add_foreign_key "thread_chats", "users"
